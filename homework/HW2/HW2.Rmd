...
```{r}
> # The casino loses money when you win, so they have 9/19 chance of losing and 10/19 chance of winning.
...
> # generate a Monte Carlo sample and look at the Z scores
error <- replicate(B,{
...
> # This roughly matches the CLT computaions above.
