...
profits. That Z score is -3.09. What interest rate goes with that? Profit here is 0, so Z score = 0-EP/SE as above.
Solving for -EP/SE = -3.09 gives int = 2.32%. Plugging into expected profit yields EP just under $1.7 million.
