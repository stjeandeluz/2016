...
> # the dichotomy between Africa and Europe/OECD is still present
...
> # in Africa seems not as much, so the original gap in 1962 has not closed.
> # Also interesting that relative decline in fertility appears to precede the  
> # increase in life expectancy when considering the whole population in the     > # graph.
